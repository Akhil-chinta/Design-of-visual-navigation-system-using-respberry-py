...
def analysis():
    ...
    IMG_SIZE = 50
    LR = 1e-3
    MODEL_NAME = 'model/dwij28leafdiseasedetection-0.001-2conv-basic.model.hdf5'
...
def openphoto():
    ...
    fileName = askopenfilename(initialdir='C:/Users/Jayanth/Desktop\DCGAN-Based Data Augmentation for Tomato Leaf Disease Identification/testpicture/', title='Select image for analysis ',
                           filetypes=[('image files', '.jpg')])
    dst = "C:/Users/Jayanth/Desktop/DCGAN-Based Data Augmentation for Tomato Leaf Disease Identification/testpicture/"
